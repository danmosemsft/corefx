    ...
    public class UTF8Encoding : Encoding
    {
        ...
        */
                                              ...
                                              byte[] bytes, int byteIndex)
        {
            ...
            fixed (char* pChars = s) fixed (byte* pBytes = (Span<byte>)bytes)
                                               ...
                                               byte[] bytes, int byteIndex)
        {
            ...
            fixed (char* pChars = chars) fixed (byte* pBytes = (Span<byte>)bytes)
                                              ...
                                              char[] chars, int charIndex)
        {
            ...
            fixed (byte* pBytes = bytes) fixed (char* pChars = (Span<char>)chars)
