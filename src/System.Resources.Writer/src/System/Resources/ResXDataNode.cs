...
namespace System.Resources {
    ...
    public sealed class ResXDataNode : ISerializable {
                ...
                if (string.Equals(mimeTypeName, ResXResourceWriter.BinSerializedObjectMimeType)
                    ...
                    if (typeName != null && typeName.Length > 0) {
                        ...
                        if (type != null) {
                            ...
                            string newMessage = string.Format(SR.TypeLoadException, typeName, dataNodeInfo.ReaderPosition.Value, dataNodeInfo.ReaderPosition.Key);
                            XmlException xml = new XmlException(newMessage, null, dataNodeInfo.ReaderPosition.Value, dataNodeInfo.ReaderPosition.Key);
                    ...
                    if (type == typeof(ResXNullRef)) {
                        ...
                        if (tc.CanConvertFrom(typeof(string))) {
                            ...
                            result = tc.ConvertFromInvariantString(text);
                                ...
                                string newMessage = string.Format(SR.NotSupported, typeName, dataNodeInfo.ReaderPosition.Value, dataNodeInfo.ReaderPosition.Key, nse.Message);
                                XmlException xml = new XmlException(newMessage, nse, dataNodeInfo.ReaderPosition.Value, dataNodeInfo.ReaderPosition.Key);
        ...
        /// </summary>
        public KeyValuePair<int, int> GetNodePosition() {
            if(nodeInfo == null) {
    ...
    internal class DataNodeInfo {
        ...
        internal KeyValuePair<int, int> ReaderPosition; //only used to track position in the reader
        ...
        internal DataNodeInfo Clone() {
            ...
            result.ReaderPosition = new KeyValuePair<int, int>(this.ReaderPosition.Key, this.ReaderPosition.Value);
            return result;
        }
    }
